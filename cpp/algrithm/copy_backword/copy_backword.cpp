 ...
 * Author        : cuiyunpeng
 * Email         : @163.com
 * Create time   : 2020-07-14 16:17
 * Last modified : 2020-07-14 16:17
 * Filename      : copy_backword.cpp
 * Description   : 
*********************************************************************/
...
{
    std::deque<string> song{"dfdh", "jinggle", "bells", "jinggle", "all", "the", "way"};    

    song.resize(song.size()+3);
    std::copy_backward(std::begin(song), 
            std::begin(song)+6, std::end(song));
