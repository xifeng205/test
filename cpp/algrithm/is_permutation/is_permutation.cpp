 ...
 * Author        : cuiyunpeng
 * Email         : @163.com
 * Create time   : 2020-07-14 14:27
 * Last modified : 2020-07-14 14:27
...
{   
    ...
    auto test = [] (const auto& d1, const auto& d2)
    {
        ...
        std::cout << (std::is_permutation(std::begin(d1), std::end(d1), std::begin(d2), std::end(d2))?"is":"is not") << " a permutation of ";
