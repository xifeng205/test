 ...
 * Author        : cuiyunpeng
 * Email         : @163.com
 * Create time   : 2020-07-16 12:45
 * Last modified : 2020-07-16 12:45
...
表 2 fmtfl 和 mask 参数可选值 标 志 	作 用
...
int main(int argc, char **argv)
{
    ...
    // const char *str1 = "I will be going comeing.";
    // std::cout.write(str, 7).write(str1, 3);
    // std::cout.tellp();
    ...
    // int b = 0x99;
    // std::cout << b << std::endl;
    // std::cout.width(10)<< b << std::endl;
    // std::cout.flags(ios::boolalpha);
    ...
    // using flow operator formatted output stream
    // std::cout << std::boolalpha() << true << std::endl;
    // std::cout << std::showpos << a << std::endl;
    
    // int c = 10;
    // std::cout << std::hex << std::showbase << c << std::endl;
    // std::cout << std::oct << std::showbase << c << std::endl;
    // std::cout << setw(10) << c << std::endl;
    // std::cout << setw(10) << std::setfill('-') << c << std::endl;
    // std::cut << setw(9) << std::setfill('-') << c << std::endl;
    
    // cin test           
    // while (1) {
        // int a;
        // if (std::cin.get() >> a == EOF) break;
        // std::cout << a << std::endl;
    // }
    
#define READ_MAX_LEN  100
    freopen("./test.txt", "r", stdin);
    char read_buf[100];
    while ( std::cin.getline(read_buf, READ_MAX_LEN))
